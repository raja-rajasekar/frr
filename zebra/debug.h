...
#define IS_ZEBRA_DEBUG_EVPN_MH_ARP_ND_EVT (zebra_debug_evpn_mh & ZEBRA_DEBUG_EVPN_MH_ARP_ND_EVT)
#define IS_ZEBRA_DEBUG_EVPN_MH_ARP_ND_PKT (zebra_debug_evpn_mh & ZEBRA_DEBUG_EVPN_MH_ARP_ND_PKT)
