...
static const struct {
	...
	[ZEBRA_ROUTE_OSPF6] = { ZEBRA_ROUTE_OSPF6, ZEBRA_OSPF6_DISTANCE_DEFAULT, META_QUEUE_NOTBGP },
	...
	[ZEBRA_ROUTE_EIGRP] = { ZEBRA_ROUTE_EIGRP, ZEBRA_EIGRP_DISTANCE_DEFAULT, META_QUEUE_NOTBGP },
	...
	[ZEBRA_ROUTE_TABLE_DIRECT] = { ZEBRA_ROUTE_TABLE_DIRECT, ZEBRA_TABLEDIRECT_DISTANCE_DEFAULT,
				       META_QUEUE_STATIC },
	...
	[ZEBRA_ROUTE_BGP_DIRECT_EXT] = { ZEBRA_ROUTE_BGP_DIRECT_EXT, ZEBRA_EBGP_DISTANCE_DEFAULT,
					 META_QUEUE_BGP },
	[ZEBRA_ROUTE_BABEL] = { ZEBRA_ROUTE_BABEL, ZEBRA_BABEL_DISTANCE_DEFAULT, META_QUEUE_NOTBGP },
	...
	[ZEBRA_ROUTE_FRR] = { ZEBRA_ROUTE_FRR, ZEBRA_STATIC_DISTANCE_DEFAULT, META_QUEUE_STATIC },
...
int rib_add_gr_run(afi_t afi, vrf_id_t vrf_id, uint8_t proto, uint8_t instance, time_t restart_time,
		   time_t update_pending_time, bool stale_client_cleanup)
{
	struct meta_q_gr_run *gr_run;
...
static void zebra_declare_gr_done(void)
{
	...
	if ((zrouter.graceful_restart)) {
		...
		if (IS_ZEBRA_DEBUG_EVENT)
			zlog_debug("GR %s: Reinstall last route and send NL INFO to CSMgr",
				   __func__);
		zebra_gr_reinstall_last_route();
	}
#endif
