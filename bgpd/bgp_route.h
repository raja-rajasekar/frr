...
extern void bgp_static_update(struct bgp *bgp, const struct prefix *p, struct bgp_static *s,
			      afi_t afi, safi_t safi, bool skip_import_check);
extern void bgp_static_withdraw(struct bgp *bgp, const struct prefix *p,
				afi_t afi, safi_t safi, struct prefix_rd *prd);

extern int bgp_static_set(struct vty *vty, struct bgp *bgp, bool negate, const char *ip_str,
			  ...
			  const char *routermac, bool skip_import_check, bool user_configured);
...
extern void route_vty_out(struct vty *vty, const struct prefix *p, struct bgp_path_info *path,
			  int display, safi_t safi, json_object *json_paths, bool wide,
			  char *rd_str);
...
extern void bgp_attr_add_soo_community(struct ecommunity *soo, struct attr *attr);
...
extern int bgp_path_info_cmp(struct bgp *bgp, struct bgp_path_info *new,
			     struct bgp_path_info *exist, int *paths_eq,
			     struct bgp_maxpaths_cfg *mpath_cfg, bool debug, char *pfx_buf,
			     afi_t afi, safi_t safi, enum bgp_path_selection_reason *reason);
